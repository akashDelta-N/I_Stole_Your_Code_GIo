...
const processInput = (input: string, cardStrength: string, calculateTotals: (counts: Record<string, number>) => Array<number>) =>
...
export const p1 = (input: string): number => processInput(input, "23456789TJQKA", (counts) => Object.values(counts).sort((a, b) => b - a));

export const p2 = (input: string): number => processInput(input,  "J23456789TQKA", (counts) => {
